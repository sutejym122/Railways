...
<body>
  <div class="header-top">
	<div class="wrap">
        <div class="logo">
			<a href="main.php"><img height="100	px" src="images/logo1.png" alt=""/></a>
		</div>
		<div class="cssmenu">
		  <nav id="nav" role="navigation">
			...
			<ul>
			<li class="get_btn"><a href="dashboard.php">Dashboard</a></li>
			<li class="get_btn"><a href="main.php">Book Tickets</a></li>
			</ul>
		    </nav>
		  </div>
		  <div class="buttons">
	     ...
	     <div class="clear"></div>
		<h2 class="head">ENTER <span class="m_1">THE DETAILS</span></h2>
     </div>
    </div>