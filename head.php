...
<body>
  <div class="header-top">
	<div class="wrap">
        <div class="logo">
			<a href="index.php"><img width ="100px" height="100px" src="images/logo1.png" alt=""/></a>
		</div>
		<div class="cssmenu">
	     ...
	     <div class="clear"></div>
		<marquee><h2 class="head">WELCOME <span class="m_1">TO </span>INDIAN<span class="m_1"> RAILWAYS</span></h2></marquee>
     </div>
    </div>